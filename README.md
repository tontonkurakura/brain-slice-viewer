...
- **2 つのアトラス** — 解剖学領域（皮質・皮質下 93 領域）と血管支配領域（ACA / MCA / PCA / VB、32 領域）
...
使っているのは公開されている標準脳（MNI152）。個人の MRI ではない。
...
| 血管支配 | [JHU Arterial Atlas](https://github.com/Chin-Fu-Liu/Arterial_Atlas) の Level 1 / 32 領域。脳底動脈は正中の 1 本として扱う（元アトラスは左右に分けている） |
